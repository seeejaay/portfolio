...
export default function Navigation() {
  return (
    <nav className="bg-grain fixed top-0 left-0 z-50 hidden w-full flex-row items-center justify-between gap-3 px-4 py-4 text-lg font-medium lg:flex lg:px-10">
